...
const sendMail = async (to, type, data) => {
  ...
  // /mailer/../../email_tempalates/welcome.html ili reset_password.html zavisno od [type]
  ...
  for (let i in data) {
    ...
    // Sekade kade imame {{}} ke gi zameni so realnata vrednost ispratena preku POSTMAN
